...
Use this chezmoi selector for a MacBook:
...
The managed SSH config includes the macOS Keychain settings only for `macbook`,
so other machines can continue using their own SSH authentication strategy.
