...
The original setup was for a Synology share exposed at `//nas.local/tank/MyStuff` and mounted at `/mnt/MyStuff`. The included files are intended as reference and starting points, not as a blindly applied setup.
